...
add.addEventListener("click", () => {
    ...
    if (newStudent.name && newStudent.date && newStudent.phone && newStudent.surname) {
        ...
        fetch("https://65d5ecaff6967ba8e3bcf8f2.mockapi.io/reception", {
            method: "POST",
            headers: {
...
function removeStudent(id) {
    fetch(`https://65d5ecaff6967ba8e3bcf8f2.mockapi.io/reception/${id}`, {
        method: "DELETE",
        headers: {
            "Content-type": "application/json"
        }
...
update.addEventListener("click", () => {
    ...
    if (newStudent.name && newStudent.date && newStudent.phone && newStudent.surname) {
        ...
        fetch(`https://65d5ecaff6967ba8e3bcf8f2.mockapi.io/reception${editData.id}`, {
            method: "PUT",
            headers: {
                "Content-type": "application/json"
            },
